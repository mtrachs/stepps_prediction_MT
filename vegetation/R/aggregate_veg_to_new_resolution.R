#--------------------------------------------------------------------------------------------------------------------------------------------
#In this script data is aggregated from a 8 km by 8 km grid to a 24 km by 24 km grid 
#--------------------------------------------------------------------------------------------------------------------------------------------
library(fields)
...
stan_rdump(c('K', 'N', 'N_knots', 
             ...
             'd_knots', 'd_inter',
             'P', 'N_p'), 
           file=paste('~/stepps_process_knots/veg_data_', K, '_taxa_', N, '_cells_', N_knots, '_knots.dump',sep=""))
...
save(K, N, N_knots, 
     ...
     d, d_knots, d_inter, 
     P, N_p,
     coord.agg.final, knot_coords, taxa,
     file=paste('~/stepps_process_knots/veg_data_', K, '_taxa_', N, '_cells_', N_knots, '_knots.rdata',sep=""))
