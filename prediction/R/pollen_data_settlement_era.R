...
library(rstan)
stan_rdump(list = names(test_neus), file = paste('~/workflow_stepps_prediction/prediction/data/elicitation_neus_certainty_median.dump',sep=''))

veg_coords <- veg_table@coords
pollen_coords <- pol_table@coords
save(list = c(names(test_neus),'veg_coords','pollen_coords'), 
     file = paste('~/workflow_stepps_prediction/prediction/data/elicitation_neus_certainty_median.RData',sep=''))
#-------------------------------------------------------------------------------------------------------------------
