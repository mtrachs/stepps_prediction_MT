...
#for(z in 1:length(pollen_chronology)){  
  ages.agg <- 200#seq(150,1950,100)
  ages <- pollen_chronology[[z]]$age
  ages.2k.index <- ((ages>125)&(ages<300))
...
saveRDS(aggregated.pollen,paste(pollen.loc,'aggregated_pollen_1700_1800.RDS',sep=''))
...
saveRDS(pollen.def,paste(pollen.loc,'pollen_1700_1800.RDS',sep=''))
...
saveRDS(coordinates.sites,paste(pollen.loc,'coordinates_1700_1800.RDS',sep=''))
